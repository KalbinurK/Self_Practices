...
public class InsuranceQode {
    public static void main(String[] args) {
        ...
        String driverL = scan.next();
        if(driverL.equals("No")){
        ...
        String accidentHistory = scan.next();
        if(accidentHistory.equals("Yes")){
